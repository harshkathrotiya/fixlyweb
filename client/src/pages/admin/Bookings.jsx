...
function Bookings() {
  ...
  useEffect(() => {
    fetchBookings();
  }, [pagination.page, sortConfig, filterStatus, dateRange]);
            ...
            <div className="grid grid-cols-1 gap-3 sm:grid-cols-2 lg:grid-cols-4">
              ...
              <div>
                ...
                <div className="relative">
                  <select
                    ...
                    className="w-full px-2 py-2 pr-6 text-xs border border-gray-300 rounded-md bg-white text-gray-700 focus:outline-none focus:ring-1 focus:ring-purple-500 focus:border-purple-500 appearance-none"
                  >
              ...
              <div>
                ...
                <input
                  type="date"
                  name="start"
                  className="w-full px-2 py-2 text-xs border border-gray-300 rounded-md text-gray-700 focus:outline-none focus:ring-1 focus:ring-purple-500 focus:border-purple-500"
              ...
              <div className="flex items-end space-x-2">
                ...
                <button
                  type="button"
                  className="flex-1 px-3 py-2 text-xs font-medium text-white bg-purple-600 hover:bg-purple-700 rounded-md focus:outline-none focus:ring-1 focus:ring-purple-500"
                        ...
                        <td className="px-6 py-4 whitespace-nowrap">
                          <div className="flex space-x-2">
                            ...
                            {booking.bookingStatus !== 'Cancelled' && booking.bookingStatus !== 'Completed' && (
                              ...
                              >
                                <i className={`fas fa-times mr-1 ${booking.bookingStatus !== 'Cancelled' && booking.bookingStatus !== 'Completed' ? 'text-red-600' : 'text-gray-600'}`}></i>
                                Cancel
                              </button>
                            )}
                            {booking.bookingStatus === 'Confirmed' && (
                              <button
                                ...
                                className="inline-flex items-center px-3 py-1 border border-gray-300 text-xs font-medium rounded text-green-700 bg-white hover:bg-green-50 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-green-500"
                              >
                    ...
                    {modalMode === 'cancel' && (
                      ...
                      >
                        ...
                        <div className="flex flex-col sm:flex-row justify-center space-y-2 sm:space-y-0 sm:space-x-3">
                          <button 
                            className="inline-flex items-center justify-center px-4 py-2 border border-gray-300 rounded-lg shadow-sm text-sm font-medium text-gray-700 bg-white hover:bg-gray-50 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-purple-500 transition-colors duration-200" 
                            onClick={handleCloseModal}
                          >
